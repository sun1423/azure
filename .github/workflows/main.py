...
async def status():
    ...
    try:
        ...
        gc.chat.completions.create(model=GROQ_MODEL, max_tokens=5, messages=[{"role":"user","content":"ok"}])
    ...
    try:
        ...
        res = reqs.get(f"https://hub.docker.com/v2/users/{DH_USERNAME}/", timeout=10)
